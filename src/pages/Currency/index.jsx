...
export default function Currency() {
  const [currencyList] = useState(['twd', 'jpy', 'usd', 'eur', 'hkd', 'krw', 'cny', 'btc']);
  ...
  }, [fromCurrency, toCurrency, setRate]);
    ...
    <div>
      <form>
        <div className="flex">
          ...
          <svg className="w-6 h-6 mt-3 mx-2 inline-block cursor-pointer" onClick={swapFromTo} xmlns="http://www.w3.org/2000/svg">
            <g fill="#000">
              <path
